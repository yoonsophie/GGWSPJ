            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block">
                    	<img alt="" src="img/alliance_icon.png" style="margin-right:20px;">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="post" class="user">
                                ...
                                <div class="form-group">
									...
									<button class="btn btn-primary btn-user btn-block" onclick="javascript:alert('동호회 회장에게 승인을 요청하였습니다. \n승인/거부는 알람으로 확인하세요!')">가입하기</button>                                
