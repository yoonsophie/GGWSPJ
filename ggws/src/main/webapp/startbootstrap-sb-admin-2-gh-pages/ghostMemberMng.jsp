...
<!-- Nav Item - Messages -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                         <!-- Page Heading -->
                    <h1 class="logo_effect" align="center"><img src="img/ghost_icon.png" style="height:80px; margin-right:50px;" "/></h1>
    ...
    <div class="container">
      ...
      <!-- 회원메뉴탭 -->	      
		      <ul class="nav nav-tabs">
		        <li class="nav-item">
		          <a class="nav-link" aria-current="page" href="memberMng.jsp">전체회원</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" aria-current="page" href="joinMemberMng.jsp">가입신청 회원</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link active" aria-current="page" href="#">휴면회원</a>
		        </li>        
		      </ul>
              ...
              <tr>
	           ...
	           <!-- 회원테이블 회원리스트
	             ...
	             <tr scope="row">
	              ...
	              <td>좋음</td>
	              <td>2023-02-21</td>
	              <td><a href="#" class="more" style="color:red">강제탈퇴</a></td> 
	             </tr>
	             <tr scope="row">
	              <td>
	                <label class="control control--checkbox">
