...
<%@page import="com.ggws.model.psaVO"%>
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							<div
								...
								<a class="dropdown-item" href="#"> <i
									...
									Settings
								</a> <a class="dropdown-item" href="profilePic"> <i
						...
						<div class="col-xl-12">
							<div class="card shadow">
								...
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">프사 바꾸기</h6>
									...
									<form action="psaService.do" method="post" enctype="multipart/form-data">
										...
										<tr>
											<td colspan="2" text-align="center">
												...
												<% if(psa==null){%>
													<img class='img-profile rounded-circle' alt='이미지' src='img/regi_pic.png' width="200px" height="200px">
												<%}else{ %>
													<img class='img-profile rounded-circle' alt='이미지' src='./profilePic/<%=psa%>' width="200px" height="200px">
												<%} %> 
												<%-- <%if(psa==null) {%>
													<img src="img/regi_pic.png">
												<%} else{ %>
												<%} %> --%>
											</td>
										</tr>
										<!-- /ggws3/src/main/webapp/startbootstrap-sb-admin-2-gh-pages/profilePic -->
											<tr>
												<td style="width : 100px"> 아이디 : </td>
												<td> <%=login_vo.getUser_id() %> 
												<input type="hidden" name="userID" value = "<%=login_vo.getUser_id() %>">
												</td>
											</tr>
											<tr>
												<td  style="width : 100px"> 사진업로드</td>
												<td colspan="2">
													<span class="btn btn-default btn-file">
														이미지를 업로드하세요. <input type="file" name="userProfilePic">
													</span>
												</td>
											</tr>
											<tr>
