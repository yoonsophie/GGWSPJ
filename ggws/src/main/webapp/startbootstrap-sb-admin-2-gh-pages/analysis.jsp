    ...
    <div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.jsp"> <i class="fas fa-fw fa-home"></i> <span>ÌôàÏúºÎ°ú</span></a>
			</li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Î∂ÑÏÑù</h1>
                   		<div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Ï†ÑÏ≤¥ ÌåÄ Í≤ΩÍ∏∞Ïàò</h6>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Ï†ÑÏ≤¥ ÌåÄ ÏäπÏàò</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">ÏÉÅÎåÄÏ†ÑÏ†Å</h6>
                                </div>
                                <div class="card-body">
                                <%	BigDecimal num = new BigDecimal(100);
						 		...
						 		%>                     	
                                     <h4 class="small font-weight-bold">Ï∂ïÍµ¨1ÌåÄ<span
                                            class="float-right"><%=list_my.get(0).getA_club_game() %>Ï†Ñ <%=list_1team.get(0).getA_club_game() %>Ïäπ <%= list_1team.get(2).getA_club_game() %>Î¨¥ <%=list_1team.get(1).getA_club_game() %>Ìå®</span></h4>
                                    ...
                                    <h4 class="small font-weight-bold">Ï∂ïÍµ¨2ÌåÄ <span
                                            class="float-right">0Ï†Ñ 0Ïäπ 0Î¨¥ 0Ìå®</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 0%"
                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">0%</div>
                                    </div>
                                    
                                    <h4 class="small font-weight-bold">Ï∂ïÍµ¨4ÌåÄ <span
                                            class="float-right"><%=list_my.get(1).getA_club_game() %>Ï†Ñ <%=list_4team.get(1).getA_club_game() %>Ïäπ <%= list_4team.get(2).getA_club_game() %>Î¨¥ <%=list_4team.get(0).getA_club_game() %>Ìå®</span></h4>
                                    <div class="progress mb-4">
                                    ...
                                    <h4 class="small font-weight-bold">EÌåÄ <span
                                            class="float-right">0Ï†Ñ 0Ïäπ 0Î¨¥ 0Ìå®</span></h4>
                                    <div class="progress mb-4">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                      ...
                      <!-- Nav Item - Messages -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
								...
								<% if(psa==null){%>
									<img class='img-profile rounded-circle' alt='¿ÃπÃ¡ˆ' src='img/regi_pic.png' >
								<%}else{ %>
									<img class='img-profile rounded-circle' alt='¿ÃπÃ¡ˆ' src='./profilePic/<%=psa%>'>
								<%} %> 
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="logo_effect" align="center">
						<img src="img/analytics_icon.png"
					...
					<div class="row">
						...
						<div class="col-xl-8 col-lg-7">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">¿¸√º ∆¿ ∞Ê±‚ºˆ</h6>
								</div>
								<div class="card-body">
									<div class="chart-area">
										<canvas id="myAreaChart"></canvas>
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">¿¸√º ∆¿ Ω¬ºˆ</h6>
								</div>
								<div class="card-body">
									<div class="chart-bar">
										<canvas id="myBarChart"></canvas>
						...
						<div class="col-xl-4 col-lg-6">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">ªÛ¥Î¿¸¿˚</h6>
								</div>
								<div class="card-body">
									<h4 class="small font-weight-bold">
										A∆¿ <span class="float-right">10¿¸ 2Ω¬ 4π´ 4∆–</span>
									</h4>
									<div class="progress mb-4">
									...
									<h4 class="small font-weight-bold">
										B∆¿ <span class="float-right">10¿¸ 4Ω¬ 4π´ 2∆–</span>
									</h4>
									<div class="progress mb-4">
									...
									<h4 class="small font-weight-bold">
										C∆¿ <span class="float-right">10¿¸ 6Ω¬ 1π´ 3∆–</span>
									</h4>
									<div class="progress mb-4">
									...
									<h4 class="small font-weight-bold">
										D∆¿ <span class="float-right">10¿¸ 8Ω¬ 2π´</span>
									</h4>
									<div class="progress mb-4">
									...
									<h4 class="small font-weight-bold">
										E∆¿ <span class="float-right">10¿¸ ¿¸Ω¬</span>
									</h4>
									<div class="progress mb-4">
