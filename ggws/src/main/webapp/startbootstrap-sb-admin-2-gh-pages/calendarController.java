	    ...
	    public String addEvent(@RequestBody List<Map<String, Object>> param) throws Exception {
		  ...
		  String result = "";
	        ...
	        for (int i = 0; i < param.size(); i++) {
	            ...
	            Timestamp start_day = (Timestamp) param.get(i).get("startday");
	            Timestamp end_day = (Timestamp) param.get(i).get("endday");
	           // String allday = (String) param.get(i).get("allday");
	 
				
				 LocalDateTime startday = LocalDateTime.parse(start_day, dateTimeFormatter);
				 LocalDateTime endday = LocalDateTime.parse(end_day, dateTimeFormatter);
	            ...
	            System.out.println(title + startday + endday);
	            int resultVO= 0;
	            
	            calendarVO vo = new calendarVO(title, startday, endday);
