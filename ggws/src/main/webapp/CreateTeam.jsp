			...
			<div class="table-responsive">
				...
				<!-- 제목 입력 -->
				  ...
				  <div class="row mb-3">
					...
					<img id="preview" alt="대표사진등록"/>
					<p/>
					<label class="btn btn-primary btn-file btn-sm">
				     사진등록 <input type="file" onchange="readURL(this);" style="display:none"> 
				    </label>
				    </div>
				  </div>
				  <!-- 제목 입력 -->
				  ...
				  <div class="row mb-3">
				    ...
				    <div class="col-sm-10">
				      <div class="form-check form-check-inline" >
						  <input class="form-check-input" type="radio" name="soccer" id="soccer" value="option1" checked>
						  <label class="form-check-label" for="soccer">
						    축구
						  </label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="baseball" id="baseball" value="option2">
						  <label class="form-check-label" for="baseball">
						    야구
						  </label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="basketball" id="basketball" value="option3">
						  <label class="form-check-label" for="basketball">
						    농구
						  </label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="volleyball" id="volleyball" value="option4">
