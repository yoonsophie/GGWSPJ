...
public class chatsubmitService implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)  { 
    	...
    	int cnt = dao.submit(dto);
    	
		if (cnt > 0) {
			System.out.println("chatsubmit 업로드 성공");
			moveURL = "chatScreen2.jsp";
		} else {
			System.out.println("chatsubmit 업로드 안됨");
			moveURL = "chatScreen2.jsp";
		}
